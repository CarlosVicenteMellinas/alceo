            ...
            <!-- Modificacion -->
                <div>
                    ...
                    <div id="alter">
                        ...
                        <form id="alterForm" action="/controllers/material/materialEditController.php" method="POST">
                            ...
                            <input type="submit" id="editarMaterial" name="editarMaterial" value="Editar Material">
                        </form>
                    </div>
                </div>
        </div>
