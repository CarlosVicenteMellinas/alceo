                ...
                <div>
                    ...
                    <div id="alter">
                        <form id="selectForm">
                            ...
                            <select id="objetivo" onchange='<?php echo 'changeValues('.json_encode($objetivo).')'; ?>'>
                        ...
                        <form id="alterForm" action="/controllers/objetivo/objetivoEditController.php" method="POST">
                            ...
                            <input type="submit" id="editarObjetivo" name="editarObjetivo" value="Editar Objetivo">
                        </form>
                    </div>
                </div>
        </div>
